...
'''
    jpg转编码               http://tomeko.net/online_tools/file_to_hex.php?lang=en
    gif 生成 jpg 参考链接   https://blog.csdn.net/mxj1428295019/article/details/125065026
    ...
    try:
        with open(filename + '.h', 'w', encoding='utf-8') as f:  # 写入文件
            ...
            while 1:
                ...
                new_height = 170  # 等比例缩放后的图像高度，根据实际需要调整
                # print(width, " ", height)
                ...
                try:
                    im.seek(im.tell() + 1) #为了节约空间 每3帧截1帧
                except EOFError:
                    # 动图读取结束
